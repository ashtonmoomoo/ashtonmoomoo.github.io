...
const title = "The Dangers of Eta Conversion in JS & TS";

const summary = "Was that a faithful refactor you just did?";
...
export const etaConversion: Post = {
  id: "dangers-of-eta-conversion",
  title,
  summary,
  mdContent,
  posted: new Date("2022-12-03"),
};
